...
export function renderLayout(contentHTML, activeRoute) {
  ...
  const navItems = [
    ...
    { label: 'School/Institution View', icon: 'school', route: '/dashboard/school' },
    { section: 'Data Collection' },
    { label: 'New Assessment', icon: 'clipboard', route: '/assessment/new' },
    { label: 'Inspections', icon: 'calendar', route: '/inspections' },
    { section: 'Governance' },
    { label: 'Validation Workflow', icon: 'layers', route: '/validation' },
...
function getBreadcrumb(route) {
  const map = {
    ...
    '/dashboard/school': 'School/Institution View',
